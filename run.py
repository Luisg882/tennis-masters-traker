...
def score_results():
    ...
    while True:
        ...
        for player in players:
            result = input(f"Did {player} win or loss?:").lower().strip()
    ...
    try:
        ...
        for value in values:
            if value == "win":
                ...
                raise ValueError("Invalid input. Enter 'win' or 'loss'.")
...
def upcoming_matches():
    ...
    upcoming = []
    # Loop through and add non-empty values to the upcoming list
...
def main():
    ...
    user don't have any results to update
            ...
            while True:
                try:
                    ...
                    if choice not in ["yes", "no"]:
                        raise ValueError("Invalid input. Enter 'yes' or 'no'.")
